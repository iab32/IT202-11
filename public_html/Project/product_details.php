    ...
    <h1>Product Detail</h1>
        ...
        <h1 style="margin-top : 20px;">Reviews</h1>
            ...
            <?php foreach ($result1 as $index1 => $record1) : ?>
                ...
                <h7 id ="noflex" style="width : 15%;margin-right : 70px;" ><?php echo "Review score: ",$order_rating; ?></h7>
                <h7 id ="noflex" style="width : 30%;" ><?php echo "Review comments : ",$order_comment; ?></h7>
                <h7 id ="noflex" style="width : 28%;" ><?php echo "Date : ",$order_created; ?></h7>
            <?php endforeach; ?>
            <?php $average_rating= $total_rating/$counter; ?>
            <?php $round_average_rating = round($average_rating, 1); ?>
            </div>
        <div class = "row">
            <h1 style="margin-top : 20px;"><u><?php echo "Average rating: ",$round_average_rating; ?></u></h1>
            <?php if($a_r >= 0) :?>
