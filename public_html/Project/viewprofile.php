    ...
    <?php if (!$edit) : ?>
        <?php if ($public) : ?>
            <?php if ($user_id == get_user_id()) : ?>
                <div style="text-align: center;">Email Address: <?php se($email); ?></div>
            <?php endif; ?>
        <div style="text-align: center;">Joined: <?php se($created); ?></div>
        <?php endif; ?>
        <div style="text-align: center;">Username: <?php se($username); ?></div>
    <?php endif; ?>
</div>
<?php
